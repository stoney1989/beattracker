 ...
 *
 */
public class CopyOfRandomizingReferenceTracker extends AbstractBeatTracker {
	private static final double JITTER = 0.1;		

	public CopyOfRandomizingReferenceTracker(File track) throws UnsupportedAudioFileException, IOException {
